...
public class SampleStore {
    ...
    public SampleUser getMember(String name, String org) {
        ...
        // Try to get the org.fhcl.common.SampleUser state from the cache
        SampleUser sampleUser = members.get(SampleUser.toKeyValStoreName(name, org));
        if (null != sampleUser) {
            return sampleUser;
        }

        // Create the org.fhcl.common.SampleUser and try to restore it's state from the key value store (if found).
